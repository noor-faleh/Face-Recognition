...
!git clone -b v3.1 https://github.com/ultralytics/yolov5  # clone repo
# %cd yolov5
...
# %cd /content
!curl -L "https://app.roboflow.com/ds/4vFrZ6MwGA?key=ZCWS9aQhlF" > roboflow.zip; unzip roboflow.zip; rm roboflow.zip
